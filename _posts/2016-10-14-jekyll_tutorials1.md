...
　我这里讲的是部署到 Github Page 创建一个 github 账号，然后创建一个跟你账户名一样的仓库，如我的 github 账户名叫 [jundali](https://github.com/jundali)，我的 github 仓库名就叫 [jundali.github.io](https://github.com/jundali/jundali.github.io)，创建好了之后，把刚才建立的 myBlog 项目 push 到 username.github.io仓库里去（username指的是你的github用户名），检查你远端仓库已经跟你本地 myBlog 同步了，然后你在浏览器里输入 username.github.io ，就可以访问你的博客了。
...
首先你要获取的我博客，[Github项目地址](https://github.com/jundali/jundali.github.io.git)，你可以直接[点击下载博客](https://github.com/jundali/jundali.github.io/archive/master.zip)，进去jundali.github.io/ 目录下， 使用命令部署本地服务 
